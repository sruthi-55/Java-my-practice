...
// Comparable defines one natural ordering inside the class through compareTo()
...
public class C03_ComparableAndComparator {
    public static void main(String[] args) {
        ...
        Comparator<Candidate> lambdaComparator = (first, second) ->
                Integer.compare(first.experience(), second.experience());
